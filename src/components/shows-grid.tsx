    ...
    <section aria-label="Grid of shows" className="container w-full max-w-none">
      ...
      <div className="main-view mt-4 min-h-[800px] pt-[5%]" id="main-view">
        {query && searchStore.loading ? (
          ...
          <div
            className={cn(
              'grid grid-cols-2 gap-x-2 gap-y-4 xs:grid-cols-3 xs:gap-y-7 sm:grid-cols-3 sm:gap-y-10 md:grid-cols-4 md:gap-y-12 lg:gap-y-14 xl:grid-cols-6 xl:gap-y-16',
